...
(function(){
 ...
 const stale=(P.records||[]).filter(r=>r.modified).map(r=>Object.assign({stuck:Math.round((_sref-new Date(r.modified))/864e5)},r)).filter(r=>r.stuck>=STALE_DAYS).sort((a,b)=>b.stuck-a.stuck);
